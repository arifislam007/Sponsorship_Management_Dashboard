...
import { attendanceSelfRouter, attendanceAdminRouter } from './routes/attendance.js';
...
app.use('/api/hr/attendance',   authMiddleware, attendanceSelfRouter);   // login/logout/today — any user
app.use('/api/hr/attendance',   authMiddleware, hrAccess, attendanceAdminRouter); // list/report/link — HR only
